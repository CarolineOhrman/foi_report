---
title: "Run 250208_M01834_0149_BCDE5"
...
current_run_id <- "250208_M01834_0149_000000000-BCDE5"
current_run <- NULL
...
**Listeria monocytogenes surveillance from food processing facilities**

**Created by:** Peter Karlsson  
**Last modified by:** Caroline Öhrman on 2025-02-09
...
p2 <- ggplot(assembly_data, aes(x = Coverage, y = N50 / 1000)) +
  ...
  labs(
    title = "Coverage vs Assembly Quality",
    x = "Coverage (X)",
    y = "N50 (kb)",
    size = "Genome Size (Mb)"
  ) +
...
resistance_data$Prevalence <- resistance_data$Samples_Positive /
  sample_count *
  100
...
p4 <- ggplot(
  resistance_data,
  aes(x = reorder(Gene, Prevalence), y = Prevalence)
) +
  geom_col(fill = "darkred", alpha = 0.8) +
  coord_flip() +
  labs(
    title = "Antimicrobial Resistance Gene Prevalence",
    x = "Resistance Gene",
    y = "Prevalence (%)"
  ) +
  theme_minimal()
...
phylo_stats <- data.frame(
  Metric = c(
    ...
    "Pan genome size",
    "Average pairwise SNPs",
    "Most distant isolates"
  ),
  Value = c(
...
- **Total isolates processed:** 24
- **Platform used:** MiSeq
- **Data yield:** 8567.4 MB
- **Quality metrics:** Q30=6,7G=74,6%
...
- **Raw data:** `/mnt/storage/sequencing-data/MiSeq_FOI_LAB/250208_M01834_0149_000000000-BCDE5/`
- **Assemblies:** [Assembly folder](../assemblies/250208_M01834_0149_000000000-BCDE5/)
- **Annotations:** [Annotation folder](../annotations/250208_M01834_0149_000000000-BCDE5/)
- **QC reports:** [MultiQC Report](../qc/250208_M01834_0149_000000000-BCDE5_multiqc.html)
